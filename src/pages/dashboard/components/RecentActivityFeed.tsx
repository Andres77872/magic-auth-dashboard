...
export function RecentActivityFeed(): React.JSX.Element {
  ...
  const { activities, isLoading, error, hasMore, refetch, loadMore } =
    useRecentActivity({
      filters,
      page,
      limit: 10,
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>
                Real-time system activity monitoring and audit trail
              </CardDescription>
            </div>
          </div>
          ...
          {isLoading && activities.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground max-w-md">
                No recent activity matches your current filters. Try adjusting
